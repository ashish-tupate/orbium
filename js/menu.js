(function(orbium) {
    orbium.Menu = function() {
        ...
        this.support = function() {
            window.location.href = "mailto:disabled@example.com";
        };
